	...
	<h4 class='toggle'>1.1.0.M4</h4>
		<div class='accordion'>
			<ul>
				...
				<li>Update Site 'http://download.eclipse.org/gemini/dbaccess/updates/1.1-M4'</li>
				<li><strong>Gemini DBAccess p2 update site</strong> -  <a href="http://www.eclipse.org/downloads/download.php?file=/gemini/dbaccess/r1.1/milestones/gemini-dbaccess-1.1.0.M4-updates.zip" target="_self">Download</a></li>
			</ul>
		</div>
